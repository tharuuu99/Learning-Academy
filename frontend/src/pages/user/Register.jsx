    ...
    <div className="flex items-center justify-center bg-gray-100 pt-14">
      <div className="p-8 bg-white rounded-lg shadow-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="flex items-center gap-5">
            <div className="mb-4">
              <label htmlFor="phoneNumber" className="block mb-2 font-bold text-gray-700">
            ...
            <div className="mb-4">
              ...
              <select {...register("gender", {required:true})} className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring focus:border-blue-300">
            ...
            <div className="text-center">
              ...
              {
                errors.password && (<div className="w-full mt-1 text-sm text-red-500">
                  <p>
